        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                        href="{{ url('konsultasi') }}" target="_blank">Konsultasi</a>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
...
<body>
    ...
    <div class="container">
        ...
        <div class="centered-text">
            <h4>Menangani Berbagai Macam Penyakit Menggunakan Pengobatan Sistem</h4>
            <h4>RAMUAN DAN FISIOTERAPI</h4>
        </div>
        <!-- Portfolio Grid Items-->
        <div class="card-container">
            <div class="card">
                <img src="{{ asset('img/st.png') }}" alt="Stroke/Lumpuh">
                <h2>STROKE/LUMPUH</h2>
                <p>Terhentinya saluran darah ke otak akibat penyumbatan</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/kt.png') }}" alt="Kanker/Tumor">
                <h2>KANKER/TUMOR</h2>
                <p>Kanker yang bisa di obati jenis seperti kanker payudara, paru-paru, kolorektal, prostat, kulit (termasuk melanoma), serta kanker darah seperti leukemia dan limfoma.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/db.png') }}" alt="diabetes">
                <h2>DIABETES</h2>
                <p>Diabetes adalah penyakit yang ditandai oleh kadar gula darah tinggi akibat masalah produksi atau penggunaan insulin.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/mata.png') }}" alt="mata">
                <h2>MATA</h2>
                <p>Penyakit mata adalah kondisi medis yang memengaruhi fungsi, struktur, atau kesehatan mata, seperti infeksi, katarak, glaukoma, dan degenerasi makula.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/jt.png') }}" alt="penyempitan saraf">
                <h2>JANTUNG</h2>
                <p>Penyakit jantung adalah kondisi medis yang memengaruhi fungsi atau struktur jantung, seperti penyakit jantung koroner, gagal jantung, atau aritmia.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/sifilis.png') }}" alt="Stroke/Lumpuh">
                <h2>SIFILIS</h2>
                <p>Sifilis adalah infeksi menular seksual yang disebabkan oleh bakteri *Treponema pallidum*, dengan gejala yang berkembang dalam beberapa tahap.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/sn.png') }}" alt="Kanker/Tumor">
                <h2>SESAK NAFAS</h2>
                <p>Sesak napas adalah kondisi di mana seseorang merasa kesulitan atau tidak nyaman saat bernapas.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/hd.png') }}" alt="diabetes">
                <h2>HIPERTENSI/DT</h2>
                <p>Hipertensi, atau darah tinggi, adalah kondisi medis di mana tekanan darah dalam arteri secara konsisten tinggi, meningkatkan risiko penyakit jantung dan stroke.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/tbc.png') }}" alt="lambung">
                <h2>TBC/BATUK KERING</h2>
                <p>TBC adalah infeksi paru-paru yang ditandai dengan batuk berkepanjangan dan dahak berdarah.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/liver.png') }}" alt="mata">
                <h2>LIVER</h2>
                <p>Liver adalah organ tubuh yang berfungsi untuk memproses nutrisi, detoksifikasi, dan produksi empedu.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/rematik.png') }}" alt="penyempitan saraf">
                <h2>REMATIK</h2>
                <p>Rematik adalah istilah umum untuk berbagai penyakit sendi dan jaringan ikat yang menyebabkan nyeri dan peradangan.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/gondok.png') }}" alt="Stroke/Lumpuh">
                <h2>GONDOK</h2>
                <p>Gondok adalah pembengkakan kelenjar tiroid yang terletak di leher, sering disebabkan oleh kekurangan yodium atau gangguan tiroid.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/amandel.png') }}" alt="Kanker/Tumor">
                <h2>AMANDEL</h2>
                <p>Amandel adalah kelenjar limfa di tenggorokan yang dapat mengalami pembengkakan atau infeksi, sering disebut sebagai radang amandel.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/lambung.png') }}" alt="diabetes">
                <h2>LAMBUNG</h2>
                <p>Penyakit lambung adalah gangguan pada organ lambung, seperti gastritis, tukak lambung, atau refluks asam.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/wasir.png') }}" alt="lambung">
                <h2>WASIR/AMBIEN</h2>
                <p>Wasir atau ambein adalah pembengkakan pada pembuluh darah di area rektum dan anus, yang menyebabkan nyeri, gatal, dan perdarahan saat buang air besar.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/ub.png') }}" alt="mata">
                <h2>USUS BUNTU</h2>
                <p>Usus buntu adalah peradangan pada apendiks, bagian kecil dari usus besar, yang menyebabkan nyeri perut, demam, dan mual.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/hernia.png') }}" alt="penyempitan saraf">
                <h2>HERNIA</h2>
                <p>Hernia adalah benjolan yang terjadi saat organ menonjol melalui dinding otot yang melemah.</p>
            </div>
            <div class="card">
                <img src="{{ asset('img/sk.png') }}" alt="penyempitan saraf">
                <h2>SARAF TERJEPIT</h2>
                <p>Saraf terjepit adalah kondisi di mana saraf tertekan atau terkompresi, menyebabkan nyeri, kesemutan, atau kelemahan di area yang terkena.</p>
            </div>
        </div>
        <div class="centered-text">
            <h4>Setiap penyakit harus diperiksa terlebih Dahulu!!</h4>
        </div>
    </div>
</section>
<!-- About Section-->
            ...
            <div
                ...
                <div
                    ...
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="exampleModalLgLabel">
                        @php
                            $sisa = 10 - count($rekam);
                        @endphp
                        Daftar Sebagai Pasien - Sisa Kouta ({{ $sisa }})
                    </h5>
                    <button type="button"
                ...
                <form action="{{ route('pasien.store') }}" method="post">
                    ...
                    <div class="modal-body relative p-4">
                        @if (count($rekam) >= 10 )
                        <center>
                            <h4 style="color:red">Kouta Pemeriksaan Hari ini Penuh!</h4>
                        </center>
                        @else
                        <a href="pasien-lama">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <label class="col-sm-5 col-form-label"><a href="{{ url('konsultasi') }}" target="_blank" type="button"
                            class="btn btn-warning">Konsultasi Klik Disini</a></label>
                ...
                <div class="modal-body">
                    <form action="{{ route('pasien.store') }}" method="post">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm">
                                <select name="doktor" class="form-control" id="dokter" required
                        ...
                        <div class="form-group row">
                                <h6 style="color:RED;">*Informasi Klinik. Jika dapat informasi dari brosur pilih warna, jika tidak, pilih Info.</h6>
                            <label class="col-sm-2 col-form-label">Info Pengobatan</label>
                            <div class="col-sm">
                                @php
                                    $warna = [
                                        'Ungu',
